...
namespace Foranj.SDK
{
    ...
    public class JsonFormatter
    {
        ...
        private static readonly string newLine = char.ConvertFromUtf32(10);
        ...
        private static void newLineIndent(int indents, StringBuilder output)
        {
                                ...
                                switch (ch)    
                                {
                                    case '[':
                                        ...
                                        if (!inString())
                                        {
                                            ...
                                            newLineIndent(context.Count, output);
                                            break;
                                        }
                                        break;
                                    case ']':
